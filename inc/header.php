...
<head>
    ...
    <link rel="icon" href="images/random.ico">

    <title>Suggestion Extraction</title>
...
<body>
        <header>
            <div class="container">
                <div class="alighleft">
               <a href="./"> <span class="logo"><span class="blue">MiSO</span></span></a>
                Mine Suggestions from Opinions
                </div>   
