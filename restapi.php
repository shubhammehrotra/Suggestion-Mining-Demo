        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul>
                    ...
                    <li><b>Input:</b>
                        <br> The API accepts input in a json format. It has three fields, which represent the input text, source of the text ("twitter" or "general"), and the language (only "en" currently) . Example of json input:
                        <pre>
{
    "text": 
    ...
    "textSource": "general",
        "language": "en"
                    ...
                    <li><b>Output:</b>
                        <br> The output json provides an array of sentences which are detected as suggestions. Example of output json:
                        <pre>
{
    "result": [
        "Just around the corner from the hotel is a fabulous little Italian restaurant - Bon Amici, I highly recommend it.",
